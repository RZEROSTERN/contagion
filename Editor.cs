...
namespace Contagion
{
    ...
    public partial class Editor : Form
    {
        ...
        private void removeButton_Click(object sender, EventArgs e)
        {
            ...
            else if (mode == CreateMode.Objects && game.objects[listBox.SelectedIndex] is Hero == false) //Don't remove the player!
            {
        ...
        private void newToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            game.objects.Add(new Hero(Vector2.Zero));
        ...
        private void SaveAs()
        {
            ...
            saveFileDialog.Filter = "Children's Story Level File (.cslf)|*.cslf";
        ...
        public void OpenLevel()
        {
            ...
            openFileDialog1.Filter = "Children's Story Level File (.cslf)|*.cslf";
